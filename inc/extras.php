 ...
 */
function kiemviet_categorized_blog() {
	$category_count = get_transient( 'kiemviet_categories' );
	...
	if ( false === $category_count ) {
		...
		set_transient( 'kiemviet_categories', $category_count );
	}
 ...
 */
function kiemviet_get_attachment_id_from_url( $attachment_url = '' ) {
	global $wpdb;
 ...
 */
function kiemviet_copyright_year( $atts ) {
	// Setup defaults.
	$args = shortcode_atts(
		[
			'starting_year' => '',
...
add_shortcode( 'kiemviet_copyright_year', 'kiemviet_copyright_year', 15 );

/*
* The settings page for site.
*/
